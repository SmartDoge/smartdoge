...
// source: smartdoge/feemarket/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "smartdoge.feemarket.v1.GenesisState")
}

func init() {
	proto.RegisterFile("smartdoge/feemarket/v1/genesis.proto", fileDescriptor_6241c21661288629)
}
