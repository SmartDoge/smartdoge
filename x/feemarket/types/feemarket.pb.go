...
// source: smartdoge/feemarket/v1/feemarket.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "smartdoge.feemarket.v1.Params")
}

func init() {
	proto.RegisterFile("smartdoge/feemarket/v1/feemarket.proto", fileDescriptor_4feb8b20cf98e6e1)
}
