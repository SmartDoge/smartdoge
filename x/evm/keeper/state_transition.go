...
func (k *Keeper) NewEVM(
	...
	blockCtx := vm.BlockContext{
		...
		GasLimit:    smartdoge.BlockGasLimit(ctx),
...
// GetHashFn implements vm.GetHashFunc for SmartDoge. It handles 3 cases:
//  1. The requested height matches the current height from context (and thus same epoch number)
//  2. The requested height is from an previous height from the same chain epoch
//  3. The requested height is from a height greater than the latest one
func (k Keeper) GetHashFn(ctx sdk.Context) vm.GetHashFunc {
	return func(height uint64) common.Hash {
		h, err := smartdoge.SafeInt64(height)
		if err != nil {
...
// returning.
//
// For relevant discussion see: https://github.com/SmartDoge/cosmos-sdk/discussions/9072
...
func (k *Keeper) ApplyMessageWithConfig(ctx sdk.Context, msg core.Message, tracer vm.EVMLogger, commit bool, cfg *types.EVMConfig, txConfig statedb.TxConfig) (*types.MsgEthereumTxResponse, error) {
	...
	// for more info https://github.com/SmartDoge/smartdoge/issues/1085
