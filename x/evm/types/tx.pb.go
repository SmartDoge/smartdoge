...
// source: smartdoge/evm/v1/tx.proto
...
import (
	...
	fmt "fmt"
	types "github.com/SmartDoge/cosmos-sdk/codec/types"
...
func init() {
	proto.RegisterType((*MsgEthereumTx)(nil), "smartdoge.evm.v1.MsgEthereumTx")
	proto.RegisterType((*LegacyTx)(nil), "smartdoge.evm.v1.LegacyTx")
	proto.RegisterType((*AccessListTx)(nil), "smartdoge.evm.v1.AccessListTx")
	proto.RegisterType((*DynamicFeeTx)(nil), "smartdoge.evm.v1.DynamicFeeTx")
	proto.RegisterType((*ExtensionOptionsEthereumTx)(nil), "smartdoge.evm.v1.ExtensionOptionsEthereumTx")
	proto.RegisterType((*MsgEthereumTxResponse)(nil), "smartdoge.evm.v1.MsgEthereumTxResponse")
}

func init() { proto.RegisterFile("smartdoge/evm/v1/tx.proto", fileDescriptor_f75ac0a12d075f21) }
...
func (c *msgClient) EthereumTx(ctx context.Context, in *MsgEthereumTx, opts ...grpc.CallOption) (*MsgEthereumTxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/smartdoge.evm.v1.Msg/EthereumTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_EthereumTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/smartdoge.evm.v1.Msg/EthereumTx",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "smartdoge.evm.v1.Msg",
	...
	Metadata: "smartdoge/evm/v1/tx.proto",
}
