...
The `x/evm` is part of the [smartdoge library](https://pkg.go.dev/github.com/SmartDoge/smartdoge). For an example of how SmartDoge can be used on any Cosmos-SDK chain, please refer to [Evmos](https://www.github.com/tharsis/evmos).
