...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "smartdoge_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "SMARTDOGE_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "SmartDoge_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "smartdoge_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "smartdoge_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "smartdoge_smartdoge_9000-1", true, nil,
		},
		{
			"invalid epoch, undefined", "smartdoge_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "smartdoge_" + strings.Repeat("1", 40) + "-1", true, nil,
		},
	}
