...
// source: smartdoge/types/v1/account.proto

package types

import (
	fmt "fmt"
	types "github.com/SmartDoge/cosmos-sdk/x/auth/types"
...
func init() {
	proto.RegisterType((*EthAccount)(nil), "smartdoge.types.v1.EthAccount")
}

func init() { proto.RegisterFile("smartdoge/types/v1/account.proto", fileDescriptor_4edc057d42a619ef) }
