...
ethermintd add-genesis-account $KEY 100000000000000000000000000wei --keyring-backend $KEYRING

# Sign genesis transaction
ethermintd gentx $KEY 1000000000000000000000wei --keyring-backend $KEYRING --chain-id $CHAINID
...
ethermintd start --pruning=nothing --evm.tracer=json $TRACE --log_level $LOGLEVEL --minimum-gas-prices=0.0001wei --json-rpc.api eth,txpool,personal,net,debug,web3,miner --api.enable
