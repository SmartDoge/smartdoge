	...
	testCases := []struct {
		...
		},
		{
			...
			func() sdk.Tx {
				...
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712TxBuilderMsgSend(from, privKey, "smartdoge_9000-1", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712TxBuilderMsgDelegate(from, privKey, "smartdoge_9000-1", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(sdk.NewCoin(evmtypes.DefaultEVMDenom, sdk.NewInt(20)))
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712TxBuilderMsgSend(from, privKey, "smartdoge_9002-1", gas, amount)
				return txBuilder.GetTx()
			}, false, false, false,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(sdk.NewCoin(evmtypes.DefaultEVMDenom, sdk.NewInt(20)))
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712TxBuilderMsgSend(from, privKey, "smartdoge_9001-1", gas, amount)
