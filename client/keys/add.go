...
import (
	...
	smartdogehd "github.com/SmartDoge/smartdoge/crypto/hd"
	...
	"github.com/SmartDoge/cosmos-sdk/crypto/keys/multisig"
...
`,
	...
	f.String(flags.FlagKeyAlgorithm, string(smartdogehd.EthSecp256k1Type), "Key signing algorithm to generate keys for")
...
func RunAddCmd(ctx client.Context, cmd *cobra.Command, args []string, inBuf *bufio.Reader) error {
	...
	if dryRun, _ := cmd.Flags().GetBool(flags.FlagDryRun); dryRun {
		...
		kb = keyring.NewInMemory(smartdogehd.EthSecp256k1Option())
	} else {
		_, err = kb.Key(name)
		if err == nil {
