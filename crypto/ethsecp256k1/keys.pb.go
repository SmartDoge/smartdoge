...
// source: smartdoge/crypto/v1/ethsecp256k1/keys.proto
...
func init() {
	proto.RegisterType((*PubKey)(nil), "smartdoge.crypto.v1.ethsecp256k1.PubKey")
	proto.RegisterType((*PrivKey)(nil), "smartdoge.crypto.v1.ethsecp256k1.PrivKey")
}

func init() {
	proto.RegisterFile("smartdoge/crypto/v1/ethsecp256k1/keys.proto", fileDescriptor_0c10cadcf35beb64)
}
