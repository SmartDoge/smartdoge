...
// transactions. There should only be a single implementation in SmartDoge. For
// the purposes of SmartDoge, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: SmartDoge will distribute the fees out to validators, so the structure
