...
import (
	...
	srvconfig "github.com/SmartDoge/cosmos-sdk/server/config"
...
func DefaultConfig() Config {
	...
	return Config{
		...
		ChainID:           fmt.Sprintf("smartdoge_%d-1", tmrand.Int63n(9999999999999)+1),
		NumValidators:     4,
		BondDenom:         smartdoge.AttoPhoton,
		MinGasPrices:      fmt.Sprintf("0.000006%s", smartdoge.AttoPhoton),
		AccountTokens:     sdk.TokensFromConsensusPower(1000, smartdoge.PowerReduction),
		StakingTokens:     sdk.TokensFromConsensusPower(500, smartdoge.PowerReduction),
		BondedTokens:      sdk.TokensFromConsensusPower(100, smartdoge.PowerReduction),
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	if !smartdoge.IsValidChainID(cfg.ChainID) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		customAppTemplate, _ := config.AppConfig(smartdoge.AttoPhoton)
